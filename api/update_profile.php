...
try {
    ...
    if (isset($data['region'])) {
        $updates[] = "region = ?";
        $params[] = sanitizeInput($data['region']);
    }
    ...
    if ($stmt->execute($params)) {
        ...
        $fetchStmt = $pdo->prepare("SELECT id, name, email, phone, address, region, level, level_name, avatar_text, profile_image, status, role, email_notif, push_notif, sms_tracking, theme FROM users WHERE id = ?");
